...
contract escrowcontract is ERC1155Holder{
    ...
    function placeorder( address _nftaddress , uint _tokenid,address _seller,uint _amount,uint _pricepernft,SaleType _saletype,uint _timeline) public {
