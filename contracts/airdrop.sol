...
contract Erc721 is ERC721, ERC721Enumerable, Pausable, Ownable {
    ...
    function airdrop(address[] memory addresses) public onlyOwner {
        ...
        {
            if((MDAccount[addresses[i]].whiteminttoken + MDAccount[addresses[i]].publicminttoken + MDAccount[addresses[i]].airdroptokens) >= 5)
            {
                continue;
            }
            else
